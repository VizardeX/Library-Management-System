...
function createRecord(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let record = req.body;
        try {
            let createdRecord = yield generateRecord(record);
...
function updateRecord(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let record = req.body;
        try {
            let updatedRecord = yield modifyRecord(record);
...
function getAllRecords(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let records = yield findAllRecords();
...
function getRecordsByProperty(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let param = req.body;
        try {
            let records = yield queryRecords(param);
